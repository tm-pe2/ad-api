...
const getAllEmployees = `
    SELECT user_id, hire_date, salary FROM employees
`
...
`
const modifyUser = `
    UPDATE users SET first_name = $2, last_name = $3, birth_date = $4, email = $5, phone_number = $6, national_registry_number = $7 WHERE id = $1;
